                ...
                if(uiStep_timer <= diff)
                {
                    switch(uiStep)
                    {
                        ...
                        case 37:
                            if(uiTroggs <= 20)
                            {
                                Creature* pTrogg = me->SummonCreature(NPC_I_TROGG, TroggSpawn, TEMPSUMMON_MANUAL_DESPAWN);
                                if(pTrogg)
                                    ++uiTroggs;
                                ...
                                Creature* pGasherikk = me->SummonCreature(NPC_GASHERIKK, TroggSpawn, TEMPSUMMON_MANUAL_DESPAWN);
                                if(pGasherikk) {
