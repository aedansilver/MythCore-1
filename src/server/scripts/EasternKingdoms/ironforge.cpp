...
public:
    ...
    {
        npc_captain_tread_sparknozzleAI(Creature* c) : ScriptedAI(c) { }
...
public:
    ...
    {
        npc_drill_sergeant_steamcrankAI(Creature* c) : ScriptedAI(c) { }
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_drill_sergeant_steamcrankAI(creature);
    }
};
