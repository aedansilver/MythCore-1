...
void mob_ashtongue_channeler::mob_ashtongue_channelerAI::JustDied(Unit* /*pKiller*/)
{
    Creature* Shade = (Unit::GetCreature((*me), ShadeGUID));
...
void mob_ashtongue_sorcerer::mob_ashtongue_sorcererAI::JustDied(Unit* /*pKiller*/)
{
    Creature* Shade = (Unit::GetCreature((*me), ShadeGUID));
    if(Shade && Shade->isAlive())
