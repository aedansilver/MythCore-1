    ...
    public:
        ...
        struct instance_culling_of_stratholme_InstanceMapScript : public InstanceScript
        {
            ...
            void OnCreatureCreate(Creature* pCreature)
            {
                ...
                {
                    case NPC_ARTHAS:    _arthasGUID = pCreature->GetGUID();             break;
                    case NPC_MEATHOOK:  _meathookGUID = pCreature->GetGUID();           break;
                    case NPC_SALRAMM:   _salrammGUID = pCreature->GetGUID();            break;
                    case NPC_EPOCH:     _epochGUID = pCreature->GetGUID();              break;
                    case NPC_MAL_GANIS: _malGanisGUID = pCreature->GetGUID();           break;
                    case NPC_INFINITE:  _infiniteGUID = pCreature->GetGUID();           break;
                    case NPC_GENERIC_BUNNY: _genericBunnyGUID = pCreature->GetGUID();   break;
                    case NPC_CITY_MAN:
                    case NPC_CITY_MAN2:
                    case NPC_CITY_MAN3:
                    case NPC_CITY_MAN4:
                    ...
                    case 31025: case 31018: case 31027: case 31028: case 30994: case 31019:
                        _citizensList.push_back(pCreature->GetGUID());
                        break;
                    case NPC_LORDAERON_CRIER: _lordaeronCrierGUID = pCreature->GetGUID(); break;
                }
            }
