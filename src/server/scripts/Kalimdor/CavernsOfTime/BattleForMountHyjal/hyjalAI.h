...
struct hyjalAI : public npc_escortAI
{
    ...
    void EnterCombat(Unit* /*pWho*/);                                  // Used to reset cooldowns for our spells and to inform the raid that we're under attack

    void UpdateAI(const uint32 diff);                       // Called to summon waves, check for boss deaths and to cast our spells.

    void JustDied(Unit* /*pKiller*/);                             // Called on death, informs the raid that they have failed.
