                ...
                switch(CurrWP)
                {
                    ...
                    case 20:
                        switch(Step)
                        {
                            case 0:
                            {
                                Creature* pNPC = me->SummonCreature(ASPECT_RAVEN, ASPECT_RAVEN_SUMMON_X, ASPECT_RAVEN_SUMMON_Y, ASPECT_RAVEN_SUMMON_Z, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 2000);
                                if(pNPC)
                                {
                                    pNPC->AddThreat(me, 10000.0f);
                                    pNPC->AI()->AttackStart(me);
                                }
                                Event_Timer = 2000;
                                Step = 1;
                                break;
