...
enum Yells
{
    ...
    SAY_REQUEST_AID                                        = -1533103,
    SAY_ANSWER_REQUEST                                     = -1533104
};
...
const Position Pos[12] =
{
    ...
    {3757.6f, -5172.0f, 143.7f, 1.97f},
    {3759.355225f, -5174.128418f, 143.802383f, 2.170104f},
    {3700.724365f, -5185.123047f, 143.928024f, 1.309310f},
    {3700.86f, -5181.29f, 143.928024f, 1.42f},
    {3754.431396f, -5080.727734f, 142.036316f, 3.736189f},
    {3724.396484f, -5061.330566f, 142.032700f, 4.564785f},
    {3732.02f, -5028.53f, 143.92f, 4.49f},
    {3687.571777f, -5126.831055f, 142.017807f, 0.604023f},
    {3707.990733f, -5151.450195f, 142.032562f, 1.376855f},
    {3782.76f, -5062.97f, 143.79f, 3.82f}
};
                    ...
                    switch(eventId)
                    {
                        ...
                        case EVENT_CHAIN:
                        {
                            ...
                            for(uint8 i = 1; i <= count; i++)
                            {
                                ...
                                if(target && !target->isCharmed() && (chained.find(target->GetGUID()) == chained.end()))
                                {
                                    ...
                                    events.ScheduleEvent(EVENT_CHAINED_SPELL, 2000);
                                }
                            }
                            if(!chained.empty())
                        ...
                        case EVENT_DETONATE:
                        {
                            ...
                            for(std::list<HostileReference*>::const_iterator itr = threatList->begin(); itr != threatList->end(); ++itr)
                                if((*itr)->getTarget()->GetTypeId() == TYPEID_PLAYER && (*itr)->getTarget()->getPowerType() == POWER_MANA && (*itr)->getTarget()->GetPower(POWER_MANA))
