    ...
    public:
        ...
        struct boss_professor_putricideAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                // To prevent stun effect from Tear gas on Proffesor Putricide
                me->ApplySpellImmune(0, IMMUNITY_ID, 71615, true);
                me->ApplySpellImmune(0, IMMUNITY_ID, 71617, true);
            ...
            void HandleTriggerSpell(AuraEffect const* aurEff)
            {
                ...
                if(Unit* caster = GetCaster())
                {
                    ...
                    if(Aura* size = caster->GetAura(70347))
                        radiusMod += size->GetStackAmount() / 4;
    ...
    public:
        ...
        class spell_putricide_unstable_experiment_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                ...
                // Bad hack - Better to find correct formulas for coords calculation
                float x, y, z, o;
                target->GetPosition(x, y, z);
                uint32 spell = uint32(GetSpellInfo()->EffectBasePoints[stage]+1);
                switch(spell)
                {
                    case 71412:
                        x = 4388.1f;
    ...
    public:
        ...
        class spell_putricide_mutated_transformation_SpellScript : public SpellScript
        {
            ...
            void HandleSummon(SpellEffIndex effIndex)
            {
                ...
                if(summon->HasAura(SPELL_MUTATED_TRANSFORMATION_DAMAGE)) // Sometimes happen twice?
                    summon->RemoveAura(SPELL_MUTATED_TRANSFORMATION_DAMAGE);
