...
int CombatAI::Permissible(const Creature* /*pCreature*/)
{
    return PERMIT_BASE_NO;
}

int ArcherAI::Permissible(const Creature* /*pCreature*/)
{
    return PERMIT_BASE_NO;
}

int TurretAI::Permissible(const Creature* /*pCreature*/)
{
    return PERMIT_BASE_NO;
}

int VehicleAI::Permissible(const Creature* /*pCreature*/)
{
    return PERMIT_BASE_NO;
}
...
bool TurretAI::CanAIAttack(const Unit* /*pWho*/) const
{
