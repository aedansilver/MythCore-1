...
class Unit : public WorldObject
{
    public:
        ...
        int32 ModSpellDuration(SpellEntry const* spellProto, Unit const* target, int32 duration, bool positive, uint32 effectMask);
        ...
        bool isJumping() const  { return m_movementInfo.HasMovementFlag(MOVEMENTFLAG_JUMPING); }
