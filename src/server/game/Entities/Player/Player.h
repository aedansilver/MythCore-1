...
private:
    ...
    void _RewardHonor(Player* pPlayer);
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool T4752;
        bool T4753;
        void Achievement3853() { T4747 = false; T4749 = false; T4750 = false; T4752 = false; T4753 = false; }
        bool Achievement3853Check()
        {
            if(T4747 == true && T4750 == true && T4749 == true && T4752 == true && T4753 == true)
            {
                if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(3853))
        ...
        bool T424;
        bool T425;
        void Achievement582() { T421 = false; T422 = false; T423 = false; T424 = false; T425 = false; }
        bool Achievement582Check()
        {
            if(T421 == true && T422 == true && T423 == true && T424 == true && T425 == true)
            {
                if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(582))
                    CompletedAchievement(pAchievment);
                return true;
            } else return false;
        }
