...
{
    {BG_IC_NPC_OVERLORD_AGMAR,NPC_OVERLORD_AGMAR,TEAM_HORDE,1312.44f,-765.733f,70.0541f,0.0f},                                      //Overlord Agmar 1
    {BG_IC_NPC_HIGH_COMMANDER_HALFORD_WYRMBANE,NPC_HIGH_COMMANDER_HALFORD_WYRMBANE,TEAM_ALLIANCE,234.983f,-831.573f,60.9034f,0.0f}, //High Commander Halford Wyrmbane 2
    {BG_IC_NPC_KOR_KRON_GUARD_1,NPC_KOR_KRON_GUARD,TEAM_HORDE,1313.01f,-773.256f,69.958f,0.292168f},                                // 3
    {BG_IC_NPC_KOR_KRON_GUARD_2,NPC_KOR_KRON_GUARD,TEAM_HORDE,1312.94f,-757.756f,69.9587f,6.02165f},                                // 4
    {BG_IC_NPC_KOR_KRON_GUARD_3,NPC_KOR_KRON_GUARD,TEAM_HORDE,1312.09f,-760.927f,69.9587f,5.94311f},                                // 5
    {BG_IC_NPC_KOR_KRON_GUARD_4,NPC_KOR_KRON_GUARD,TEAM_HORDE,1312.13f,-769.7f,69.95f,0.34f},                                       // 6

    {BG_IC_NPC_SEVEN_TH_LEGION_INFANTRY_1,NPC_SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,234.969f,-822.958f,60.8151f,0.46337f},         // 7
    {BG_IC_NPC_SEVEN_TH_LEGION_INFANTRY_2,NPC_SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,235.211f,-826.952f,60.8188f,6.25961f},         // 8
    {BG_IC_NPC_SEVEN_TH_LEGION_INFANTRY_3,NPC_SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,234.119f,-838.386f,60.8145f,5.64857f},         // 9
    {BG_IC_NPC_SEVEN_TH_LEGION_INFANTRY_4,NPC_SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,234.889f,-835.102f,60.8201f,6.21642f},         // 10
...
class BattlegroundIC : public Battleground
{
    ...
    public:
        ...
        void EventPlayerDamagedGO(Player* /*pPlayer*/, GameObject* go, uint32 eventType);
