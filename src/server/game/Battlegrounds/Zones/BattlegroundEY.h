...
enum BG_EY_Achievements
{
    ACHIEV_FLURRY_START_EVENT   = 13180,
};
...
class BattlegroundEY : public Battleground
{
    ...
    public:
        ...
        void HandleKillPlayer(Player* pPlayer, Player* pKiller);
    ...
    private:
        ...
        void EventPlayerCapturedFlag(Player* /*pSource*/) { }
        ...
        uint32 m_HonorTics;
        uint8 _400Ally40Horde; // 400 ALLY, 40 HORDE
};
#endif