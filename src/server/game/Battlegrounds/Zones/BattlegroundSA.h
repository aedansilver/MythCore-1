...
class BattlegroundSA : public Battleground
{
    ...
    public:
        ...
        {
            switch(id) {
                case 19041: return BG_SA_GREEN_GATE;    //Green gate
                case 19040: return BG_SA_BLUE_GATE;     //blue gate
                case 19042: return BG_SA_RED_GATE;      //red gate
                case 19043: return BG_SA_PURPLE_GATE;   //purple gate
                case 19044: return BG_SA_YELLOW_GATE;   //yellow gate
                case 19836: return BG_SA_ANCIENT_GATE;  //ancient gate
                default: return 0;
            }
        }
        ...
        {
            switch(id) {
                case 19046: return BG_SA_GREEN_GATE;
                case 19045: return BG_SA_BLUE_GATE;
                case 19047: return BG_SA_RED_GATE;
                case 19048: return BG_SA_PURPLE_GATE;
                case 19049: return BG_SA_YELLOW_GATE;
                case 19837: return BG_SA_ANCIENT_GATE;
                default: return 0;
            }
        }
        ...
        {
            switch(id) {
                case BG_SA_GREEN_GATE:      return BG_SA_GREEN_GATEWS;
                case BG_SA_YELLOW_GATE:     return BG_SA_YELLOW_GATEWS;
                case BG_SA_BLUE_GATE:       return BG_SA_BLUE_GATEWS;
                case BG_SA_RED_GATE:        return BG_SA_RED_GATEWS;
                case BG_SA_PURPLE_GATE:     return BG_SA_PURPLE_GATEWS;
                case BG_SA_ANCIENT_GATE:    return BG_SA_ANCIENT_GATEWS;
                default: return 0;
            }
        }
