...
void BattlegroundAB::Update(uint32 diff)
{
    ...
    {
        if(m_TimerAchievementLetsGetThisDone > 0)
            m_TimerAchievementLetsGetThisDone -= diff;
...
void BattlegroundAB::RemovePlayer(Player* /*pPlayer*/, uint64 /*guid*/, uint32 /*team*/) { }
...
void BattlegroundAB::Reset()
{
    ...
    m_TimerAchievementLetsGetThisDone = 361000;
