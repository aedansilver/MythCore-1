...
class Battleground
{
    ...
    public:
        ...
        virtual void DestroyGate(Player* /*pPlayer*/, GameObject* /*pGo*/) { }
        ...
        virtual void HandleAreaTrigger(Player* /*pSource*/, uint32 /*Trigger*/) { }
        // must be implemented in BG subclass if need AND call base class generic code
        virtual void HandleKillPlayer(Player* player, Player* killer);
        virtual void HandleKillUnit(Creature* /*pUnit*/, Player* /*killer*/);

        // Battleground events
        virtual void EventPlayerDroppedFlag(Player* /*pPlayer*/) { }
        virtual void EventPlayerClickedOnFlag(Player* /*pPlayer*/, GameObject* /*target_obj*/) { }
        virtual void EventPlayerCapturedFlag(Player* /*pPlayer*/) { }
        void EventPlayerLoggedIn(Player* player);
        void EventPlayerLoggedOut(Player* player);
        virtual void EventPlayerDamagedGO(Player* /*pPlayer*/, GameObject* /*pGo*/, uint32 /*eventType*/) { }
        virtual void EventPlayerUsedGO(Player* /*pPlayer*/, GameObject* /*pGo*/){ }

        // this function can be used by spell to interact with the BG map
        virtual void DoAction(uint32 /*action*/, const uint64& /*var*/) { }

        virtual void HandlePlayerResurrect(Player* /*pPlayer*/) { }
        ...
        virtual bool HandlePlayerUnderMap(Player* /*pPlayer*/) { return false; }
    ...
    protected:
        ...
        // must be implemented in BG subclass
        virtual void RemovePlayer(Player* /*pPlayer*/, uint64 /*guid*/, uint32 /*team*/) { }
