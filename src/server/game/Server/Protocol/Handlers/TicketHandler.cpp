...
void WorldSession::HandleGMTicketCreateOpcode(WorldPacket & recv_data)
{
    ...
    if(!sTicketMgr->GetTicketByPlayer(GetPlayer()->GetGUID()))
    {
        ...
        sWorld->SendTextByAccess(SEC_GAMEMASTER_LOW, true, LANG_COMMAND_TICKETNEW, GetPlayer()->GetName(), ticket->GetId());
...
void WorldSession::HandleGMTicketUpdateOpcode(WorldPacket & recv_data)
{
    ...
    if(GmTicket *ticket = sTicketMgr->GetTicketByPlayer(GetPlayer()->GetGUID()))
    {
        ...
        sWorld->SendTextByAccess(SEC_GAMEMASTER_LOW, true, LANG_COMMAND_TICKETUPDATED, GetPlayer()->GetName(), ticket->GetId());
...
void WorldSession::HandleGMTicketDeleteOpcode(WorldPacket & /*recv_data*/)
{
    if(GmTicket* ticket = sTicketMgr->GetTicketByPlayer(GetPlayer()->GetGUID()))
    {
        ...
        sWorld->SendTextByAccess(SEC_GAMEMASTER_LOW, true, LANG_COMMAND_TICKETPLAYERABANDON, GetPlayer()->GetName(), ticket->GetId());
