...
void OutdoorPvP::HandlePlayerResurrects(Player* /*pPlayer*/, uint32 /*zone*/) { }
...
bool OPvPCapturePoint::HandleCustomSpell(Player* plr, uint32 /*spellId*/, GameObject* /*pGo*/)
{
...
bool OPvPCapturePoint::HandleGossipOption(Player* /*pPlayer*/, uint64 /*guid*/, uint32 /*id*/)
{
    return false;
}

bool OPvPCapturePoint::CanTalkTo(Player* /*pPlayer*/, Creature* /*c*/, GossipMenuItems const& /*gso*/)
{
    return false;
}

bool OPvPCapturePoint::HandleDropFlag(Player* /*pPlayer*/, uint32 /*id*/)
{
    return false;
}

int32 OPvPCapturePoint::HandleOpenGo(Player* /*pPlayer*/, uint64 guid)
{
...
bool OutdoorPvP::HandleAreaTrigger(Player* /*pPlayer*/, uint32 /*trigger*/)
{
    return false;
}
